<template>
  <div class="home-wrap panel-border">
    <h1 class="text-h1 center">广告创意生成心理学研究实验平台</h1>
    <nav class="nav-links">
      <router-link to="/pre-subject">预实验-被试版</router-link>
      ...
      <router-link to="/study3-process">研究三-被试版(过程组)</router-link>
      <router-link to="/study3-result">研究三-被试版(结果组)</router-link>
      <router-link to="/study3-admin">研究三-主试版</router-link>
    </nav>
  </div>
</template>
