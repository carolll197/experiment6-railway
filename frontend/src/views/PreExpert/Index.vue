<template>
  <div class="pre-expert">
    <Step0Info v-if="step === 0" v-model:name="expertName" @next="step = 1" />
    <Step1Flow v-else-if="step === 1" @next="step = 2" />
    <Step2Score v-else-if="step === 2" :expert-name="expertName" @next="step = 3" />
