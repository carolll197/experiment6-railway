<template>
  <div class="intro-wrap">
    <h1 class="text-h1 center">实验内容说明-环节一</h1>
    <div class="file-container">
      <p class="text-body">您好，欢迎参加本次创意实验！在接下来的研究中，您将扮演一名"广告创意总监"。现在为"独立撰写"环节，系统将为您提供一份创意简报题目（包含产品功能特性等信息），您需要在【10分钟内】，独立构思出一份广告创意策划方案，此后，我们也会提供一份AI作品供您选择，谢绝自行使用AI生成答案。</p>
      <p class="text-body">额外奖金： 我们将邀请行业专家对作品的创造力进行盲审排名，您最终作品的创造力将与奖金相关，请尽情发挥您的创造力！</p>
    </div>
    <div class="file-container">
