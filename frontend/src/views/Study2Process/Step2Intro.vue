<template>
  <div class="intro-wrap">
    ...
    <div class="file-container">
      <p class="text-body">您好，欢迎参加本实验！您会收到一份创意简报（包括广告主题、产品特征等信息），完成1份广告策划案的撰写。在本实验中，系统内置的AI 将作为您的创意合作伙伴，您可以与它进行【8分钟的限时讨论】；8分钟倒计时结束后AI会生成方案供您参考。最终提交的广告策划案的创造力与实验报酬挂钩。</p>
