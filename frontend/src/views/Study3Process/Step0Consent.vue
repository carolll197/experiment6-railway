<template>
  <div class="consent-wrap">
    ...
    <div class="file-container">
      <p class="text-body">欢迎您参与本次关于"广告创意生成"的心理学研究。在决定是否参与之前，请仔细阅读以下信息。</p>
      <p class="text-body"><strong>1. 研究背景与目的</strong> 本研究旨在探索个体在AI辅助下如何进行广告策划与创意构思。</p>
      <p class="text-body"><strong>2. 实验流程与任务</strong> 本实验预计耗时约10分钟，全程在线进行，您将与AI协作完成1份广告创意策划案。</p>
      <p class="text-body"><strong>3. 审核说明</strong> 请您认真完成实验，后台将检测作答质量，对于态度敷衍、胡乱作答的，将不予发放任何报酬。</p>
...
<style scoped>
.consent-wrap { min-height: 100vh; background: var(--color-page-bg); padding: 16px; display: flex; flex-direction: column; align-items: center; gap: 16px; }
...
.file-container { width: 90%; max-width: 800px; background: #F0F9FF; border-left: 4px solid #57adde; padding: 16px; }
